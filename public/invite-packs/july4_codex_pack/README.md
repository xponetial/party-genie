...
1. Copy the PNG files into your app's public template assets folder.
2. Load `manifest.json` to seed your template catalog.
3. Use the `text_safe_areas` metadata to position overlay text fields.
