...
export default function PrivacyPage() {
  return (
    <LegalPage
      title="Privacy"
      intro="PartyGenie is built to collect only the host, guest, RSVP, AI usage, and delivery data needed to run the event-planning workflow inside the beta product."
      sections={[
        {
          title: "What we collect",
          body: [
            "We store host account details, event information, guest lists, invite content, RSVP responses, shopping items, tasks, and settings needed to operate the PartyGenie workspace.",
        ...
        },
        {
          ...
          body: [
            "PartyGenie uses hosted providers to power core product functions, including Supabase for application data, OpenAI for AI generation when enabled, and Resend for invite email delivery.",
        ...
        },
        {
          ...
          body: [
            ...
            "If you need account or event data removed, contact the PartyGenie team through the same channel used to access the beta and we can help coordinate deletion requests while the product is still in limited release.",
          ],
        },
        {
